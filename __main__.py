...
TECHNO_IMG = "https://https://telegra.ph/file/d6dd64ae61198fe6407be"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/DEVILRAVANXOP")],
                                                                                   [InlineKeyboardButton(text="ADD XRAVAN💥⚡ TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/RAVANXOP/XRAVAN")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("Yuss, I am ALIVE SURR🥺💥⚡")
